...
## ACCIONES SUGERIDAS:
Sabiendo que, de los 2038 clientes que abandonaron en total, 448 son **mujeres alemanas, este segmento de clientes representa un 21.98% de los clientes que abandonaron y al mismo tiempo solo un 4.48% de los clientes totales del banco**, se hace pertinente el accionar urgente de programas de fidelización y marketing enfocado especfícamente en este segmento de clientes del banco, ya que esto permitiría solucionar una gram parte de la fuga centrando recursos y minimizando costos al enfocarse en un grupo reducido de la población total:
