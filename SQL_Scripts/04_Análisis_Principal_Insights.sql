...
-- Identificación de la distribución de abandono vs. retención.
-- =============================================================================
SELECT 
...
-- Objetivo: Identificar zona geográfica más crítica. 
...
-- Hallazgo: Tasa de Abandono en Mujeres supera por mucha diferencia a la tasa de los hombres.
-- =============================================================================
SELECT 
      c.Genero AS Genero,
...
--          Pero las que tienen 3 y 4 productos presentan un riesgo mortal (86% y 100%), la zona más crítica
SELECT
      Cant_de_Prod,
      SUM(Abandono) AS CantidadAbandono,
...
-- 5.4. Correlación con Actividad en el banco
